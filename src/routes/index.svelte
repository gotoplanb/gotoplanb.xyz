		...
		<div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
			...
			>
				<div class="sm:hidden md:block mt-6 min-w-0 flex-1">
					<h1 class="text-2xl font-bold text-gray-900 truncate">gotoplanb.eth/sol/tez</h1>
				</div>
				<div
				...
				>
					...
					>
						<span><a href="https://twitter.com/gotoplanb">Twitter</a></span>
					</button>
					<button
						type="button"
						class="inline-flex justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
					>
						<span><a href="https://discord.gg/9bTj25Hcvp">Discord</a></span>
					</button>
				</div>
			</div>
		</div>
